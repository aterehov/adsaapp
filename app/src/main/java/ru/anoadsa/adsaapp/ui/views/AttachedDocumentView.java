...
public class AttachedDocumentView extends ConstraintLayout {
    ...
    public AttachedDocumentView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.AttachedDocumentView,
                0,
                0
        );
...
//            enabled = a.getBoolean(R.styleable.TitleSpinnerView_enabledTSV, true);
        ...
        LayoutInflater.from(context).inflate(R.layout.view_attached_document, this);
