 ...
 */
public class FixedDonutProgress extends View
{
    ...
    public FixedDonutProgress(Context context)
    {
        this(context, null);
    }

    public FixedDonutProgress(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public FixedDonutProgress(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    protected void initByAttributes(TypedArray attributes)
    {
        ...
        // FIXED BY ME
        clockWise = attributes.getBoolean(R.styleable.DonutProgress_donut_clockWise, true);
    }
