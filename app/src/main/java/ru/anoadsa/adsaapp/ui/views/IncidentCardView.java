...
public class IncidentCardView extends ConstraintLayout {
    ...
    public IncidentCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.IncidentCardView,
                0,
                0
        );
        ...
        LayoutInflater.from(context).inflate(R.layout.view_incident_card, this);
